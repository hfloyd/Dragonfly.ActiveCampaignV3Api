namespace Dragonfly.ActiveCampaign.Queries
{
    ...
    public class CalendarFeedsRequest : ActiveCampaignRequest<CalendarFeedsList>
    {
        private string listEndPoint = "calendars";
        private string singleEndPoint = "calendars";
        ...
        /// </summary>
        public List<CalendarFeedsList.LinkedData> IncludeExtraData { get; set; }

        public CalendarFeedsRequest(ActiveCampaignConnection Connection) : base(Connection)
        {
            this.IncludeExtraData = new List<CalendarFeedsList.LinkedData>();
        }
        ...
        {
            return CalendarFeedsList.GetLinkedDataParamsList(this.IncludeExtraData);
        }
